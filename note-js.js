...
//"use strict";  строгий режим, следит за правильным написанием кода, например написано ли слово let перед переменной (https://learn.javascript.ru/strict-mode)

var name = 'Nik'; // устаревший; var область видимости ограничена функцией (функциональная переменная), а let и const только в своих блоках (например в циклах)

let apple = 'Green'; // изменяемамя переменная
...
undefined // значение переменной отсутствует
...
(num === 50) ? console.log('Ok!') : console.log('Error');           //тернарный оператор, позволяет короче код ()
...
//код закомментирован, потому что html :)
// <!DOCTYPE html>
// <html lang="en">
// <head>
//     <meta charset="UTF-8">
